...
const Skills = (props) => {
  ...
  return (
    <>
      {
        page == "about" ? (
          <div className='md:size-72 size-40 shadow-2xl rounded-xl flex justify-center items-center bg-[#46474b] hover:bg-[#ffc86b] transition-colors' data-aos="fade-up">
          ...
          <a href={props.link} target="_blank" className='cursor-pointer my-2' data-aos="zoom-in">
